...
from .apis import (
    ...
    OrganizationEmployeeAPIView,
    CreateOrganizationsConnectionsAPI,
    OrganizationConnectionAPI,
    AddressListAPI,
    AddressDetailAPI,
...
urlpatterns = [
    path(
        "/connections/<int:pk>",
        OrganizationConnectionAPI.as_view(),
        name="organization-connection",
    ),
    path(
        "/connections",
        CreateOrganizationsConnectionsAPI.as_view(),
        name="organization-connection-create",
    ),
    path(
        "/employees/<int:pk>",
        OrganizationEmployeeAPIView.as_view(),
