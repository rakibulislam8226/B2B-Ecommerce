...
from .apis import ProductCreateAPI, ProductListAPI, CartListAPI, CartCreateAPI, \
...
urlpatterns = [
    ...
    path('/carts/items/<uuid:uid>', CartItemUpdateDeleteAPI.as_view(), name='cart-item-update-delete'),
    ...
    path('/orders/items/<str:uid>', OrderItemsDetailAPI.as_view(), name='order-items-detail'),
